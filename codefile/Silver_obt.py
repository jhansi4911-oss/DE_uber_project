...
display(spark.sql("""CREATE OR REFRESH STREAMING TABLE silver_obtAS 
...
df = spark.sql("""CREATE OR REFRESH STREAMING TABLE silver_obtAS 
...
# MAGIC  requires_auth
# MAGIC from 
# MAGIC   uber_project.bronze.silver_obt

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC select * from uber_project.bronze.dim_passenger

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SHOW COLUMNS FROM uber_project.bronze.silver_obt
# MAGIC
...
# MAGIC %sql
# MAGIC
# MAGIC select * from uber_project.bronze.fact
